  ...
  return (
    <div className='w-full px-4 dark:bg-backdarkdm h-[30rem] '>
      ...
      <div className='mb-6  mx-auto'>
        <h3 className='mb-2 font-bold text-2xl md:text-2xl text-black dark:text-gray-300  ml-2'>Portuguese</h3>
      ...
      <div className='mb-6 max-w-[70rem] mx-auto'>
        <h3 className='mb-2 font-bold text-2xl md:text-2xl text-black dark:text-gray-300 ml-3'>English</h3>
      ...
      <div className='mb-2 max-w-[70rem] mx-auto'>
        <h3 className='mb-2 font-bold text-2xl md:text-2xl text-black dark:text-gray-300 ml-3'>Changana</h3>
      ...
      <div className='mb-2 max-w-[70rem] mx-auto'>
        <h3 className='mb-3 font-bold text-2xl md:text-2xl text-black dark:text-gray-300 ml-3'>Spanish</h3>
